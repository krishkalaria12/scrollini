...
- Scrollini remembers the previous workspace. `workspace_auto_back_and_forth` makes
...
`excluded_keybindings` can pass specific shortcuts through before scrollini maps
