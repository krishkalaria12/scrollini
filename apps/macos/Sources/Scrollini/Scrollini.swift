...
final class Scrollini: NSObject, NSMenuDelegate, @unchecked Sendable {
    ...
    private var loadedConfig = ScrolliniConfig.loadWithMetadata()
    private var config: ScrolliniConfig {
        loadedConfig.config
    }
    ...
    private var statusMenuSnapshot: ScrolliniMenuSnapshot {
    ...
    private func presentSettingsView() {
        ...
        settingsWindow.contentView = NSHostingView(rootView: ScrolliniSettingsView(
            config: config,
    ...
    @discardableResult
    private func saveConfigFromSettingsWindow(_ newConfig: ScrolliniConfig) -> Bool {
        let url = settingsURL
    ...
    private func applyLoadedConfig(_ newLoadedConfig: LoadedScrolliniConfig) {
